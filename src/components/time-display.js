...
import { hrsToMsecs, toTimeString } from './../utils.js';

const hourTypes = {
  working: { hours: [11.5, 8.5, 4.5, 0], classes: ['compoff', 'fullday', 'halfday', 'absent'] },
  nonworking: { hours: [6, 0], classes: ['fullday-compoff', 'absent'] }
};
